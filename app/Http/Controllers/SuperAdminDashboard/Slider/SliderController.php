...
class SliderController extends Controller
{
    ...
    private $filePath = 'adminAsset/slider_image/';
    ...
    public function store(SliderRequest $request)
    {
        ...
        if ($request->hasFile('slider_image') && $request->file('slider_image')->isValid()) {
            $slider->slider_image = $this->fileuploadService->setPath($this->filePath)->saveOptimizedImage($request->file('slider_image'), 40, 1320, null, true);
        }
        $slider->save();
